...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> RegistroUsuarioExterno (string urlRetorno=null, string remoteError = null)
        {
            ...
            if (info is null)
            {
                mensaje = "Cargando datos del login externo";
                return RedirectToAction("login", routeValues: new { mensaje });
        ...
        [Authorize(Roles = Constantes.RolAdmin)] //Vista accesible a los marcados como admin
        public async Task<IActionResult> Listado (string mensaje = null)
        {   
            //traemos el usuario de la tabla Users en DBContext filtrado por Mail.
