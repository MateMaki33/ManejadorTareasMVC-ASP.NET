...
namespace TareasMVC.Controllers
{
    ...
    public class PasosController : ControllerBase
    {
        ...
        [HttpPut("{id}")] //no se pone tipo de dato porque en este caso el id es de tipo Guid
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var tarea = await context.Tareas.FirstOrDefaultAsync(tarea => tarea.Id == tareaId && tarea.UsuarioCreacionId == usuarioId);
